...
* The original package name 'com.mail.Mail OTP ' is invalid and this project uses 'com.mail.Mail.OTP' instead.
...
* [Java Mail Sender](https://docs.spring.io/spring-boot/docs/3.3.1-SNAPSHOT/reference/htmlsingle/index.html#io.email)
